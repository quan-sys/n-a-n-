...
## Command
`python.exe scripts\run_evidence_pack_policy_01.py --output-dir data\reports\evidence_pack_policy_01`

## Input status
- ranked_input_status: MISSING_RANKING_INPUT
- document_index_status: LOADED:data/reports/official_finance_documents_01ie/finance_document_index.csv
- template_only: True
- MISSING_RANKING_INPUT: Yes
- No real investment ranking was inferred.
...
## Workload
- assignment_estimated_files_min: 0
- assignment_estimated_files_max: 0
- evidence_collection_queue_rows: 0
...
- NO_OFFICIAL_EVIDENCE_NEEDED_YET: 6
...
_Generated at 2026-06-10T14:36:32+00:00._